...
public class TurismoController {
    ...
    public ResponseEntity<ResponseBase<TurismoDto>> create(@RequestBody TurismoDto dto) {
        TurismoDto creado = turismoService.createTurismo(dto);
        return ResponseEntity.ok(new ResponseBase<>(true, "Turismo creado correctamente", creado));
    }
